    ...
    <div class="intec-content-wrapper">
        <div class="row">
            <div class="col-md-4 col-xs-12">
                <img alt="sofa" src="#SITE_DIR#images/sofa.png">
            </div>
            <div class="col-md-8 col-xs-12">
                ...
                <div class="intec-about-company-more">
                    <a href="<?= SITE_DIR ?>company/" class="intec-button intec-button-md intec-button-cl-common intec-button-transparent">Подробнее</a>
                </div>
            </div>
        </div>
    </div>
