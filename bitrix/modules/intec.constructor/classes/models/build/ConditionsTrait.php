...
trait ConditionsTrait
{
     ...
     * @return bool
     */
    public function isConditioned($directory = null, $path = null, $url = null, $parametersGet = null, $parametersPage = null, $parametersTemplate = null)
    {
        ...
        $function = function ($condition) use (&$function, &$path, &$url, &$parametersGet, &$parametersPage, &$parametersTemplate) {
