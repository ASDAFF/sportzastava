...
?>
<div class="constructor-dialog constructor-component-properties" data-bind="{
    ...
    <div class="constructor-dialog-wrapper">
                    ...
                    <div class="constructor-dialog-content-wrapper">
                        <div class="constructor-dialog-content-wrapper-2">
                            <div class="constructor-dialog-title">
                                <?= GetMessage('container.modals.component.properties.form-title') ?>
                            </div>
        ...
        <div class="constructor-dialog-footer">
            <div class="constructor-dialog-content-wrap">
                <div class="constructor-dialog-content constructor-dialog-buttons-wrap constructor-button-group constructor-button-size-3 constructor-button-font-14">
                    <div class="constructor-button constructor-button-blue constructor-save-button"
                         data-bind="click: componentProperties.save">
                        <?= GetMessage('container.modals.component.properties.button-save') ?>
                    </div>
                    <div class="constructor-button constructor-button-transparent-blue"
                         data-bind="click: componentProperties.close">
                        <?= GetMessage('container.modals.component.properties.button-cancel') ?>
                    </div>
                </div>
            </div>
        </div>
