...
class WidgetActions extends Actions
{
    ...
    public function beforeAction($action)
    {
        ...
        if (parent::beforeAction($action)) {
            ...
            $widgetTemplate = $widget->getTemplate($widgetTemplate, $build, $template);
    ...
    public function actionHandle()
    {
        ...
        if (empty($this->widgetTemplate)) {
            ...
            return $this->widgetTemplate->handle(
                $this->properties,
                $parameters,
                $this->build,
                $this->template
    ...
    public function actionHeaders()
    {
        ...
        if ($applyWidget)
            $this->widget->includeHeaders();

        if ($applyTemplate)
            $this->widgetTemplate->includeHeaders();
