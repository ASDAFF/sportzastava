...
$lAdmin->AddHeaders(array(
    ...
    array(
        "id" => "CONDITION_ID",
        "content" => GetMessage("SEO_META_TABLE_CONDITION_ID"),
        "sort" => "CONDITION_ID",
        "default" => true,
    ),
    array(
...
while($arRes = $rsData->NavNext(true, "f_"))
{
    ...
    else
    {
        ...
        $row->AddViewField("IN_SITEMAP", $f_IN_SITEMAP == 'Y' ? GetMessage("SEO_META_POST_YES") : GetMessage("SEO_META_POST_NO"));
...
<form name="find_form" method="get" action="<?=$APPLICATION->GetCurPage();?>">
    ...
    <tr>
        <td><?=GetMessage("SEO_META_IN_SITEMAP")?>:</td>
        <td>
            <?
                $arr = array(
                    "reference" => array(
