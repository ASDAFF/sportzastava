...
if (!empty($arParams['TEMPLATE_THEME']) && !is_file($server->getDocumentRoot().'/bitrix/css/main/themes/'.$arParams['TEMPLATE_THEME'].'/style.css')) {
			...
			<form action="<?= $APPLICATION->GetCurPage() ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
				...
				<div id="bx-soa-order" class="row bx-<?= $arParams['TEMPLATE_THEME'] ?>" style="opacity: 0;">
					...
					<div class="col-md-9 bx-soa">
						...
						<div id="bx-soa-auth" class="bx-soa-section bx-soa-auth" style="display:none;">
							<div class="bx-soa-section-title-container">
								<h2 class="bx-soa-section-title col-sm-9">
									<?= $arParams['MESS_AUTH_BLOCK_NAME'] ?><span class="bx-soa-section-title-count"></span>
								</h2>
							</div>
						...
						<?php if (!isset($arParams['BASKET_POSITION']) || $arParams['BASKET_POSITION'] === 'before') { ?>
							<!--	BASKET ITEMS BLOCK	-->
							<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
								<div class="bx-soa-section-title-container">
									<h2 class="bx-soa-section-title col-xs-8 col-sm-9">
										<?= $arParams['MESS_BASKET_BLOCK_NAME'] ?><span class="bx-soa-section-title-count"></span>
									</h2>
						...
						<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
							<div class="bx-soa-section-title-container">
								<h2 class="bx-soa-section-title col-xs-8 col-sm-9">
									<?= $arParams['MESS_REGION_BLOCK_NAME'] ?><span class="bx-soa-section-title-count"></span>
								</h2>
								<div class="col-xs-4 col-sm-3 text-right">
									<a href="" class="bx-soa-editstep">
										<?= $arParams['MESS_EDIT'] ?>
									</a>
								</div>
							</div>
						...
						<?php if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d') { ?>
							...
							<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active">
								<div class="bx-soa-section-title-container">
									<h2 class="bx-soa-section-title col-xs-8 col-sm-9">
										<?= $arParams['MESS_PAYMENT_BLOCK_NAME'] ?><span class="bx-soa-section-title-count"></span>
									</h2>
									<div class="col-xs-4 col-sm-3 text-right">
										<a href="" class="bx-soa-editstep">
											<?= $arParams['MESS_EDIT'] ?>
							...
							<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active" <?= $hideDelivery ? 'style="display:none"' : '' ?>>
								<div class="bx-soa-section-title-container">
									<h2 class="bx-soa-section-title col-xs-8 col-sm-9">
										<?= $arParams['MESS_DELIVERY_BLOCK_NAME'] ?><span class="bx-soa-section-title-count"></span>
									</h2>
									<div class="col-xs-4 col-sm-3 text-right">
										<a href="" class="bx-soa-editstep">
											<?= $arParams['MESS_EDIT'] ?>
						...
						<?php } else { ?>
							...
							<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active" <?= $hideDelivery ? 'style="display:none"' : '' ?>>
								...
								<div class="bx-soa-section-content container-fluid clearfix"></div>
							</div>
							<!--	PICKUP BLOCK	-->
							<div id="bx-soa-pickup" data-visited="false" class="bx-soa-section" style="display:none;">
								<div class="bx-soa-section-title-container">
						...
						<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
							<div class="bx-soa-section-title-container">
								<h2 class="bx-soa-section-title col-xs-8 col-sm-9">
									<?= $arParams['MESS_BUYER_BLOCK_NAME'] ?><span class="bx-soa-section-title-count"></span>
								</h2>
								<div class="col-xs-4 col-sm-3 text-right">
									<a href="" class="bx-soa-editstep">
										<?= $arParams['MESS_EDIT'] ?>
						...
						<div id="bx-soa-orderSave">
							...
							<a href="javascript:void(0)"
							   style="margin: 10px 0;"
							   class="pull-right intec-button intec-button-cl-common intec-button-lg"
