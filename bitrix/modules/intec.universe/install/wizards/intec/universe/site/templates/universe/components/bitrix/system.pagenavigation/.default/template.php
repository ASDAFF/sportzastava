...
<?if($arResult["bDescPageNumbering"] === true):?>
	...
	<?else:?>
			...
			<li class="bx-active" class="intec-cl-background"><span class="">1</span></li>
	<?endif?>
	...
	?>
		...
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<li class="bx-active"><span class="intec-cl-background"><?=$NavRecordGroupPrint?></span></li>
		<?else:?>
	...
	<?else:?>
		<?if($arResult["NavPageCount"] > 1):?>
			<li class="bx-active" class="intec-cl-background"><span><?=$arResult["NavPageCount"]?></span></li>
		<?endif?>
...
<?else:?>
	...
	?>
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<li class="bx-active"><span class="intec-cl-background"><?=$arResult["nStartPage"]?></span></li>
		<?else:?>
	...
	<?else:?>
		<?if($arResult["NavPageCount"] > 1):?>
			<li class="bx-active"><span class="intec-cl-background"><?=$arResult["NavPageCount"]?></span></li>
		<?endif?>
			<li class="bx-pag-next"><span></span></li>
	<?endif?>
<?endif?>
