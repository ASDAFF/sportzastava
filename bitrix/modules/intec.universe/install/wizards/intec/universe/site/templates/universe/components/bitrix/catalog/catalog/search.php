...
if (!empty($oProperties)) {
    ...
    switch ($oProperties->get('default_products_view')) {
        case 'tile':
            $arParams['DEFAULT_PRODUCTS_VIEW'] = 'tile';
            break;
        case 'list':
            $arParams['DEFAULT_PRODUCTS_VIEW'] = 'list';
            break;
        case 'text':
            $arParams['DEFAULT_PRODUCTS_VIEW'] = 'text';
            break;
        default:
            $arParams['DEFAULT_PRODUCTS_VIEW'] = 'tile';
            break;
    ...
    <div class="intec-content-wrapper">
        <?$APPLICATION->IncludeComponent(
            ...
            array(
                ...
                'DEFAULT_PRODUCTS_VIEW' => (!empty($arParams['DEFAULT_PRODUCTS_VIEW']))?$arParams['DEFAULT_PRODUCTS_VIEW']:'tile',
            ),
            $component,
            array("HIDE_ICONS" => "Y")
        );
