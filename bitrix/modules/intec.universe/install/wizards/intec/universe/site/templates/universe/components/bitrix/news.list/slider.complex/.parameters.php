...
if (!empty($sIBlockType) && !empty($iIBlockId)) {
    ...
    //Текст ярлыка
    /*$arTemplateParameters['PROPERTY_COMPLEX_BANNER_MARK_TEXT'] = array(
        'PARENT' => 'DATA_SOURCE',
        'NAME' => GetMessage('PROPERTY_COMPLEX_BANNER_MARK_TEXT'),
        'TYPE' => 'LIST',
        'VALUES' => $CBPropsString
    );*/

    //Цвет текста ярлыка
    /*$arTemplateParameters['PROPERTY_COMPLEX_BANNER_MARK_TEXT_COLOR'] = array(
        'PARENT' => 'DATA_SOURCE',
        'NAME' => GetMessage('PROPERTY_COMPLEX_BANNER_MARK_TEXT_COLOR'),
        'TYPE' => 'LIST',
        'VALUES' => $CBPropsString
    );*/

    //Цвет ярлыка
    /*$arTemplateParameters['PROPERTY_COMPLEX_BANNER_MARK_COLOR'] = array(
        'PARENT' => 'DATA_SOURCE',
        'NAME' => GetMessage('PROPERTY_COMPLEX_BANNER_MARK_COLOR'),
        'TYPE' => 'LIST',
        'VALUES' => $CBPropsString
    );*/
