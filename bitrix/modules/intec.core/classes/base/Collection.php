 ...
 * @package core\base
 */
class Collection extends Object implements \IteratorAggregate, \ArrayAccess, \Countable, \Serializable
{
    protected $items = [];
     ...
     */
    public function getRange($keys, $collection = true) {
        $items = [];
