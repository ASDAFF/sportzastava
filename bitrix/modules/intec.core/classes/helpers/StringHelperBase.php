...
class StringHelperBase
{
    ...
    {
        if (mb_strlen($string, $encoding ?: Core::$app->charset) > $length) {
            return rtrim(mb_substr($string, 0, $length, $encoding ?: Core::$app->charset)) . $suffix;
        } else {
            return $string;
        }
    }
    ...
    public static function convert($string, $encodingTo = null, $encodingFrom = null)
    {
        ...
        $encodingTo = Encoding::resolve($encodingTo, Encoding::TYPE_DEFAULT, true);
        $encodingFrom = Encoding::resolve($encodingFrom);
        ...
        if ($encodingTo) {
            ...
            $string = $encodingFrom ?
                mb_convert_encoding($string, $encodingTo, $encodingFrom) :
                mb_convert_encoding($string, $encodingTo);
        }
