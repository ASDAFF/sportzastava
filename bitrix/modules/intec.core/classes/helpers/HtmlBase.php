...
use intec\core\db\ActiveRecordInterface;
use intec\core\validators\StringValidator;
...
class HtmlBase
{
    ...
    {
        return htmlspecialchars($content, ENT_QUOTES | ENT_SUBSTITUTE, Core::$app ? Core::$app->charset : 'UTF-8', $doubleEncode);
    }
    ...
    {
        $header = isset($options['header']) ? $options['header'] : '<p>' . Core::t('core', 'Please fix the following errors:') . '</p>';
