    ...
    public static function convertEncoding($array, $encodingTo = null, $encodingFrom = null)
    {
        ...
        if (Type::isArray($array))
            foreach ($array as $key => $item) {
                $key = StringHelper::convert($key, $encodingTo, $encodingFrom);

                if (Type::isArray($item)) {
                    $result[$key] = static::convertEncoding($item, $encodingTo, $encodingFrom);
                } else if (Type::isString($item)) {
                    $result[$key] = StringHelper::convert($item, $encodingTo, $encodingFrom);
                } else {
                    $result[$key] = $item;
                }
            }
