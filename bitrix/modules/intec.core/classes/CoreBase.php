...
class CoreBase
{
     ...
     * @param string|null $encoding Кодировка. Если `null`, то берется из кодировки приложения.
     * @return string Переведенное сообщение.
     */
    public static function t($category, $message, $params = [], $language = null, $encoding = null)
    {
        if ($encoding === null) {
            $encoding = static::$app ? static::$app->charset : Encoding::UTF8;
        }
        ...
        return StringHelper::convert($message, $encoding);
    }
