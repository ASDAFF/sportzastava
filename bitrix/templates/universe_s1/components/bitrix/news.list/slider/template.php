                ...
                <?php if ($sPosition != 'center') { ?>
                    <div class="slider-item-wrapper <?= $sPosition ?>">
                        <div class="intec-content intec-content-visible">
                            ...
                            <?/*
                            <div class="slider-image-wrapper" style="vertical-align: <?= $sBannerImagePosition ? $sBannerImagePosition : 'middle'?>">
                                <?php if (!empty($sBannerImage)) { ?>
                                    <img src="<?= $sBannerImage ?>" style="vertical-align: <?= $sBannerImagePosition ? $sBannerImagePosition : 'middle'?>">
                                <? } ?>
                            </div>
                            */?>
