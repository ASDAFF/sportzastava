...
$arTemplateParameters['IBLOCK_TYPE'] = array(
    'PARENT' => 'BASE',
    'NAME' => GetMessage('M_HORIZONTAL_PARAMETERS_IBLOCK_TYPE'),
    'TYPE' => 'LIST',
...
$arTemplateParameters['IBLOCK_ID'] = array(
    'PARENT' => 'BASE',
    'NAME' => GetMessage('M_HORIZONTAL_PARAMETERS_IBLOCK_ID'),
    'TYPE' => 'LIST',
    'VALUES' => $arIBlocks,
    'REFRESH' => 'Y',
    'ADDITIONAL_VALUES' => 'Y'
...
if (!empty($iIBlockId)) {
    ...
    $arTemplateParameters['PROPERTY_IMAGE'] = array(
        'PARENT' => 'DATA_SOURCE',
        'NAME' => GetMessage('M_HORIZONTAL_PARAMETERS_PROPERTY_IMAGE'),
        'TYPE' => 'LIST',
        'VALUES' => $arFields,
        'REFRESH' => 'Y',
        'ADDITIONAL_VALUES' => 'Y'
...
$arTemplateParameters['DEFAULT_VIEW'] = array(
    'PARENT' => 'VISUAL',
    'NAME' => GetMessage('M_HORIZONTAL_PARAMETERS_DEFAULT_VIEW'),
    'TYPE' => 'LIST',
    'VALUES' => array(
        'default' => GetMessage('M_HORIZONTAL_PARAMETERS_DEFAULT_VIEW_DEFAULT')
    )
);

$arTemplateParameters['SECTION_VIEW'] = array(
    'PARENT' => 'VISUAL',
    'NAME' => GetMessage('M_HORIZONTAL_PARAMETERS_SECTION_VIEW'),
    'TYPE' => 'LIST',
    'VALUES' => array(
        'default' => GetMessage('M_HORIZONTAL_PARAMETERS_SECTION_VIEW_DEFAULT'),
        'with.images' => GetMessage('M_HORIZONTAL_PARAMETERS_SECTION_VIEW_WITH_IMAGES')
    )
);