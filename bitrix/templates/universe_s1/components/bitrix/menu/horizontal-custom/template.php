        ...
        <div class="intec-content">
            <div class="intec-content-wrapper">
                <div class="menu-wrapper" data-role="items">
                    ...
                    ?>
                        <div class="menu-item menu-item-default<?= $bSelected ? ' menu-item-active intec-cl-text intec-cl-background-light' : null ?> intec-cl-background-light-hover <?=($isDefaultMenu && !$isTransparent)?'intec-cl-border-light menu-item-border':''?> <?=(!$isDefaultMenu)?'intec-cl-text-hover':''?>" data-role="item">
